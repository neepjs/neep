...
function init(normalizeAuxiliaryObject, node, slots, components, native, simpleSlot) {
  return refresh(() => postpone(() => exec$1(node, normalizeAuxiliaryObject, slots, components, native, simpleSlot)));
}
...
var Neep = /*#__PURE__*/Object.freeze({
	...
	get encase () { return encase; },
	get valueify () { return valueify; },
	get asValue () { return asValue; },
	get mixValue () { return mixValue; },
	get defineProperty () { return defineProperty; },
	ref: ref,
	watch: watch,
	useValue: useValue,
...
export default Neep;
export { Container, NeepError as Error, Fragment, Render, ScopeSlot, Slot, Template, addContextConstructor, addEntityConstructor, addRecognizer, addRendererDraw, asValue, byService, callHook, checkCurrent, componentValueSymbol, componentsSymbol, computed, createStandardComponent as createComponent, createContainerComponent, createDeliverComponent, createElement, createElementBase, createElementComponent, createNativeComponent, createRenderComponent, createRenderElement, createShellComponent, createSimpleComponent, createStandardComponent, createTemplateElement, current, defineProperty, deliverDefaultSymbol, deliverKeySymbol, elements, encase, equal, execUseHooks, getNode, hook, install, isContainerComponent, isDeliverComponent as isDeliver, isDeliverComponent, isElement, isElementComponent, isFragmentElement, isNativeComponent, isProduction, isProxy, isRenderComponent, isRenderElement, isShellComponent, isSimpleComponent, isSimpleElement, isValue, label, lazy, mixValue, nameSymbol, nextTick, objectTypeSymbol, objectTypeSymbolContainerComponent, objectTypeSymbolDeliverComponent, objectTypeSymbolElement, objectTypeSymbolElementComponent, objectTypeSymbolHookEntity, objectTypeSymbolNativeComponent, objectTypeSymbolRenderComponent, objectTypeSymbolRootEntity, objectTypeSymbolShellComponent, objectTypeSymbolSimpleComponent, propsSymbol, ref, refresh, register, render, rendererSymbol, setHook, useService, useValue, value, valueify, version, watch };
