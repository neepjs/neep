 ...
 * @license MIT
 */
import { postpone as postpone$1 } from 'monitorable';
...
export default Neep;
export { Container, NeepError as Error, EventEmitter, Fragment, ScopeSlot, Slot, SlotRender, Template, Value, addContextConstructor, addEntityConstructor, asValue, byService, callHook, checkCurrent, componentsSymbol, computed, configSymbol, create, createDeliver, createElement, current, deliverDefaultSymbol, deliverKeySymbol, elements, encase, equal, expose, getRect, hook, install, isDeliver, isElement, isProduction, isSimpleElement, isSimpleTag, isValue, label$1 as label, lazy, mComponent, mConfig, mName, mNative, mRender, mSimple, mType, mark, nameSymbol, objectTypeSymbol, objectTypeSymbolDeliver, objectTypeSymbolElement, recover, ref, refresh, register, render, renderSymbol, setHook, typeSymbol, useService, useValue, value, valueify, version, watch };
