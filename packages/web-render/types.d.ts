...
declare const _default: {
    ...
    type: string;
    mount(props: MountProps, parent?: IRender | undefined): [NativeContainer, NativeNode];
    unmount(container: NativeContainer, node: NativeNode, removed: boolean): any;
    draw(container: NativeContainer, node: NativeNode): void;
    drawContainer(container: NativeContainer, node: NativeNode, props: MountProps, parent?: IRender | undefined, isSelf?: boolean | undefined): [NativeContainer, NativeNode];
    isNode(v: any): v is NativeNode;
    create(tag: string, props: Record<string, any>): NativeElement;
    update(node: NativeElement, props: Record<string, any>): void;
    text(text: string): NativeText;
    placeholder(): NativePlaceholder;
    parent(node: NativeNode): NativeElement | NativeComponent | NativeShadow | null;
    next(node: NativeNode): NativeElement | NativeComponent | NativeShadow | NativeText | NativePlaceholder | null;
    insert(parent: NativeContainer, node: NativeNode, next?: NativeElement | NativeComponent | NativeShadow | NativeText | NativePlaceholder | null | undefined): void;
    remove(n: NativeNode): void;
};
